...
class ParticipantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create participant" do
    assert_difference("Participant.count") do
      post participants_url, params: { participant: { points: @participant.points, ranking: @participant.ranking } }
    end
  ...
  test "should update participant" do
    patch participant_url(@participant), params: { participant: { points: @participant.points, ranking: @participant.ranking } }
